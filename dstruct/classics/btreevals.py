class KeyedBinaryTree():
    ...
    def __repr___(self): return repr(self.tree)
    def lookup(self, key): return self.tree.lookup(key)
    def insert(self, key, value): self.tree = self.tree.insert(key, value)
...
class BinaryNode:
    def __init__(self, left, key, val, right) -> None:
    ...
    def __repr__(self) -> str:
        return f'({repr(self.left)}, {repr(self.key)}, {repr(self.val)},{repr(self.right)})'
